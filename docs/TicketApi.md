...
------------- | ------------- | -------------
[**add_ticket**](TicketApi.md#add_ticket) | **POST** /cars/{plate}/tickets | Buy a ticket for a car
...
[**get_tickets_by_plate**](TicketApi.md#get_tickets_by_plate) | **GET** /cars/{plate}/tickets | Get tickets by plate
[**get_tickets_by_user_id**](TicketApi.md#get_tickets_by_user_id) | **GET** /users/{id}/tickets | Get all tickets of a user


# **add_ticket**
> TicketResponse add_ticket(plate, ticket_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Buy a ticket for a car
        api_response = api_instance.add_ticket(plate, ticket_request)
        print("The response of TicketApi->add_ticket:\n")
        pprint(api_response)
...
# **get_tickets_by_plate**
> List[TicketResponse] get_tickets_by_plate(plate)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get tickets by plate
        api_response = api_instance.get_tickets_by_plate(plate)
        print("The response of TicketApi->get_tickets_by_plate:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TicketApi->get_tickets_by_plate: %s\n" % e)
```
...
> List[TicketResponse] get_tickets_by_user_id(id, valid_only=valid_only)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all tickets of a user
        api_response = api_instance.get_tickets_by_user_id(id, valid_only=valid_only)
        print("The response of TicketApi->get_tickets_by_user_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TicketApi->get_tickets_by_user_id: %s\n" % e)
```
