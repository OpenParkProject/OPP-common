...
------------- | ------------- | -------------
[**add_car_fine**](FineApi.md#add_car_fine) | **POST** /fines/{plate} | Issue a new fine for a car
[**delete_fines**](FineApi.md#delete_fines) | **DELETE** /fines | Delete all fines
[**get_car_fines**](FineApi.md#get_car_fines) | **GET** /fines/{plate} | Get fine by plate
[**get_fines**](FineApi.md#get_fines) | **GET** /fines | Get all fines
[**get_user_fines**](FineApi.md#get_user_fines) | **GET** /users/{username}/fines | Get all fines of a user
...
# **get_user_fines**
> List[FineResponse] get_user_fines(username)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.FineApi(api_client)
    username = 'johndoe' # str | Username of user that owns the fines

    try:
        # Get all fines of a user
        api_response = api_instance.get_user_fines(username)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **username** | **str**| Username of user that owns the fines | 
