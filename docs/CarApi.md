...
------------- | ------------- | -------------
[**add_user_car**](CarApi.md#add_user_car) | **POST** /users/{username}/cars | Add a new car to a user
[**delete_cars**](CarApi.md#delete_cars) | **DELETE** /cars | Delete all cars
[**delete_user_car**](CarApi.md#delete_user_car) | **DELETE** /users/{username}/cars/{plate} | Delete an existing car from a user
[**get_cars**](CarApi.md#get_cars) | **GET** /cars | Get all cars
[**get_user_cars**](CarApi.md#get_user_cars) | **GET** /users/{username}/cars | Get all cars of a user
[**update_user_car**](CarApi.md#update_user_car) | **PATCH** /users/{username}/cars/{plate} | Update an existing car of a user


# **add_user_car**
> Car add_user_car(username, car)
...
# Defining the host is optional and defaults to http://opp-backend:8080/api/v1
# See configuration.py for a list of all supported configuration parameters.
configuration = openapi_client.Configuration(
    host = "http://opp-backend:8080/api/v1"
)
...
------------- | ------------- | ------------- | -------------
 **username** | **str**| Username of user that owns the cars | 
...
# **delete_user_car**
> delete_user_car(username, plate)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.CarApi(api_client)
    username = 'johndoe' # str | Username of user that owns the car
    plate = 'ABC123' # str | Plate of car to operate on

    try:
        # Delete an existing car from a user
        api_instance.delete_user_car(username, plate)
    except Exception as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **username** | **str**| Username of user that owns the car | 
...
# **get_user_cars**
> List[Car] get_user_cars(username, currently_parked=currently_parked)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all cars of a user
        api_response = api_instance.get_user_cars(username, currently_parked=currently_parked)
...
# **update_user_car**
> Car update_user_car(username, plate, car)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    username = 'johndoe' # str | Username of user that owns the car
    plate = 'ABC123' # str | Plate of car to operate on
    car = openapi_client.Car() # Car | Update an existing car of a user

    try:
        # Update an existing car of a user
        api_response = api_instance.update_user_car(username, plate, car)
