...
class TicketResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["plate", "start_date", "id", "end_date", "price", "status", "creation_time"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['unpaid', 'active', 'expired']):
            raise ValueError("must be one of enum values ('unpaid', 'active', 'expired')")
        return value
