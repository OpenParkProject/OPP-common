...
class ZoneUserRoleResponse(BaseModel):
    """
    ...
    assigned_by: StrictStr
    __properties: ClassVar[List[str]] = ["username", "role", "id", "zone_id", "assigned_at", "assigned_by"]

    @field_validator('role')
    def role_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['admin', 'controller']):
            raise ValueError("must be one of enum values ('admin', 'controller')")
        return value
