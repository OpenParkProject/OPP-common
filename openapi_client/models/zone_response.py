...
class ZoneResponse(BaseModel):
    ...
    geometry: StrictStr = Field(description="GeoJSON string")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="JSONB field")
    price_offset: Union[StrictFloat, StrictInt]
    price_lin: Union[StrictFloat, StrictInt]
    price_exp: Union[StrictFloat, StrictInt]
    id: StrictInt
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["name", "available", "geometry", "metadata", "price_offset", "price_lin", "price_exp", "id", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price_offset": obj.get("price_offset"),
            "price_lin": obj.get("price_lin"),
            "price_exp": obj.get("price_exp"),
            "id": obj.get("id"),
