...
class UserRequest(BaseModel):
    ...
    password: StrictStr
    role: StrictStr
    __properties: ClassVar[List[str]] = ["name", "surname", "username", "email", "password", "role"]

    @field_validator('role')
    def role_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['driver', 'controller', 'admin']):
            raise ValueError("must be one of enum values ('driver', 'controller', 'admin')")
        return value
