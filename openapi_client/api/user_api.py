...
class UserApi:
    ...
    def add_user(
        self,
        user: Annotated[User, Field(description="Create a new user (Registration)")],
        ...
        :param user: Create a new user (Registration) (required)
        :type user: User
    ...
    def delete_user_by_id(
        self,
        id: Annotated[StrictInt, Field(description="ID of user to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def update_user(
        ...
        user: Annotated[User, Field(description="Update an existing user")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type id: int
        :param user: Update an existing user (required)
        :type user: User
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
