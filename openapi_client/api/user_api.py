...
class UserApi:
    ...
    def add_user(
        self,
        user_request: Annotated[UserRequest, Field(description="Create a new user (Registration)")],
        ...
        :param user_request: Create a new user (Registration) (required)
    ...
    def update_user(
        self,
        username: Annotated[StrictStr, Field(description="Username of user to return")],
        user_request: Annotated[UserRequest, Field(description="Update an existing user")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param username: Username of user to return (required)
        :type username: str
        :param user_request: Update an existing user (required)
        :type user_request: UserRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
