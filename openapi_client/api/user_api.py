...
class UserApi:
    ...
    def delete_user_by_id(
        self,
        id: Annotated[StrictInt, Field(description="ID of user to return")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def update_user_by_id(
        self,
        id: Annotated[StrictInt, Field(description="ID of user to return")],
        user_request: Annotated[UserRequest, Field(description="Update an existing user by ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID of user to return (required)
        :type id: int
        :param user_request: Update an existing user by ID (required)
