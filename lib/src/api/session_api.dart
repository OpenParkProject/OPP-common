...
class SessionApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetPubKey200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetPubKey200Response>> getPubKey({ 
    ...
    GetPubKey200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetPubKey200Response),
      ) as GetPubKey200Response;
    ...
    return Response<GetPubKey200Response>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SessionResponse>> getSession({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [SessionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SessionResponse>> login({ 
  ...
  /// Returns a [Future] containing a [Response] with a [SessionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SessionResponse>> register({ 
