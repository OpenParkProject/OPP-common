...
class UserApi {
  ...
  ///
  /// Parameters:
  /// * [userRequest] - Create a new user (Registration)
  ...
  Future<Response<UserResponse>> addUser({ 
  ...
  Future<Response<void>> deleteUser({ 
    ...
    final _path = r'/users/{username}'.replaceAll('{' r'username' '}', encodeQueryParameter(_serializers, username, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteUsers({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<UserResponse>>> getUsers({ 
    int? limit = 20,
    int? offset = 0,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Parameters:
  /// * [username] - Username of user to return
  /// * [userRequest] - Update an existing user
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [UserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponse>> updateUser({ 
    required String username,
    required UserRequest userRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
