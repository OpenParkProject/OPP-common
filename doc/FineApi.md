...
------------- | ------------- | -------------
[**addCarFine**](FineApi.md#addcarfine) | **POST** /fines/{plate} | Issue a new fine for a car
[**deleteFines**](FineApi.md#deletefines) | **DELETE** /fines | Delete all fines
[**getCarFines**](FineApi.md#getcarfines) | **GET** /fines/{plate} | Get fine by plate
[**getFines**](FineApi.md#getfines) | **GET** /fines | Get all fines
[**getUserFines**](FineApi.md#getuserfines) | **GET** /users/{username}/fines | Get all fines of a user
...
# **getUserFines**
> BuiltList<FineResponse> getUserFines(username)
...
final api = OppApiClient().getFineApi();
final String username = johndoe; // String | Username of user that owns the fines

try {
    final response = api.getUserFines(username);
    print(response);
} catch on DioException (e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **username** | **String**| Username of user that owns the fines | 
