...
class TestTicketApi(unittest.TestCase):
    ...
    def test_get_tickets_by_plate(self) -> None:
        """Test case for get_tickets_by_plate

        Get tickets by plate
        """
        pass

    def test_get_tickets_by_user_id(self) -> None:
        """Test case for get_tickets_by_user_id
