...
class TestFineResponse(unittest.TestCase):
    """FineResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FineResponse:
        """Test FineResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FineResponse`
        """
        model = FineResponse()
        if include_optional:
            return FineResponse(
