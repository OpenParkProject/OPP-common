...
class TestOTPValidationRequest(unittest.TestCase):
    """OTPValidationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OTPValidationRequest:
        """Test OTPValidationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OTPValidationRequest`
        """
        model = OTPValidationRequest()
        if include_optional:
    ...
    def testOTPValidationRequest(self):
        """Test OTPValidationRequest"""
