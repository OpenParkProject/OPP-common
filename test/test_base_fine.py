...
class TestBaseFine(unittest.TestCase):
    """BaseFine unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseFine:
        """Test BaseFine
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseFine`
        """
        model = BaseFine()
        if include_optional:
            return BaseFine(
